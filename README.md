...
必要ファイルを同梱した日本語化パックを用意しているため、個別にダウンロードする必要はありません。
...
1. 必要ファイルを同梱した[CU日本語化パック](https://mega.nz/file/X5sTTSbK#IGJ-cRl___nkeLkHGkyzzGfoPn1HfreJOu7Vt6yFFYU) をダウンロード。
...
4. すべてのファイルの配置が終わったら、`CasualtiesUnknown.exe` からゲームを起動。
5. タイトル画面右上の言語選択メニューから **「日本語」** を選択。  
...
日本語化パックでBepInExを導入した場合、設定変更はファイルを保存した後にゲーム内テキストを再表示すると反映されます。ゲーム内の書き置きなどを見つけた際に、表示を確認しながらお好みの設定に調整するのがおすすめです。

***

## 🔠 CUFontPatcherについて

[CUFontPatcher](https://github.com/marui-neko/CUFontPatcher)は、ゲーム内のフォントを任意のカスタムフォントに置き換え、自動改行を導入する BepInEx プラグインです。  
...
yuzupenkai_u_2019  
https://black-yuzunyan.lolipop.jp/fonts-yuzu-pen-kai
...
アームド・レモン  
https://www.vector.co.jp/soft/data/writing/se334877.html


適当ポエム  
https://booth.pm/ja/items/4806814
